<?php include('header.php') ?>
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(bg.jpg);">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
              ...
              <p><a href="order.php?pizza_name=Italian Cuizine" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <span class="subheading">Crunchy</span>
              ...
              <p class="mb-4 mb-md-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              <p><a href="order.php?pizza_name=Italian Pizza" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
            <div class="col-md-6 ftco-animate">
    ...
    <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex">
              ...
              <li class="ftco-animate"><a href="https://www.facebook.com/share/1ABuJdExVQ/"><span class="icon-facebook"></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/sahiil.x22?igsh=MWsxMHo1Nmc0MWloaA=="><span class="icon-instagram"></span></a></li>
            </ul>
	    		</div>
    		</div>
    	</div>
 ...
 <section class="ftco-section">
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters d-flex">
    				...
    				<div class="services-wrap d-flex">
    					...
    					<div class="text p-4">
    						...
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia </p>
								...
								<p class="price"><span>₹180</span><a href="order.php?pizza_name=Italian Pizza&price=₹180" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					...
    					<div class="text p-4">
    						<h3>Greek Pizza</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
								<p class="price"><span>₹199</span><a href="order.php?pizza_name=Greek Pizza&price=₹199" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="order.php" class="img" style="background-image: url(images/pizza-3.jpg);"></a>
    					<div class="text p-4">
    						<h3>Caucasian Pizza</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    					
								<p class="price"><span>₹120</span><a href="order.php?pizza_name=Caucasian Pizza&price=₹120" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="order.php" class="img order-lg-last" style="background-image: url(images/pizza-4.jpg);"></a>
    					<div class="text p-4">
    						<h3>American Pizza</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia </p>
    					
								<p class="price"><span>₹169</span><a href="order.php?pizza_name=American Pizza&price=₹169" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="order.php" class="img order-lg-last" style="background-image: url(images/pizza-5.jpg);"></a>
    					<div class="text p-4">
    						<h3>Tomatoe Pie</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    			
								<p class="price"><span>₹99</span><a href="order.php?pizza_name=Tomatoe Pie&price=₹99" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="order.php" class="img order-lg-last" style="background-image: url(images/pizza-6.jpg);"></a>
    					<div class="text p-4">
    						<h3>Margherita</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    		
								<p class="price"><span>₹120</span><a href="order.php?pizza_name=Margherita&price=₹120" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    		</div>
